Template.commentToQuestion.helpers({
  reason: function () {
    return !!Meteor.user() ? i18n.t('sorry_you_do_not_have_the_rights_to_comments'): i18n.t('please_log_in_to_comment');
  }
});

Template.commentToQuestion.events({
  'submit form#cToq': function(e, instance){
    ...
    var comment = {};
    var $commentForm = instance.$('#commentToq');
